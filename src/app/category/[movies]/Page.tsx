  ...
  return (
    <>
      <div className="mx-auto pl-20 pt-[59px] pb-8 lg:pb-[76px] space-y-8">
        <h2 className="mt-8 text-2xl font-medium capitalize text-foreground lg:mt-[52px] lg:text-3xl">upcoming</h2>
        <div className="flex flex-wrap gap-5 lg:gap-8"> {loading ? (
                  <p>Loading</p>
                ) : errorMessage ? (
                  <p>{errorMessage}</p>
                ) : (
